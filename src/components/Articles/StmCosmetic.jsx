...
import demoImg from '../../img/articles/300x400.png';
                ...
                <section>
                    <div className="container">
                        <div className="article-table-content-wrap">
                            <div className="article-table-content">
                                <h3>Оглавление:</h3>
                                <ul>
                                    <li><a href="#">Шаг 1: Исследовать целевую аудиторию и конкурентов</a></li>
                                    <li><a href="#">Шаг 2. Определить концепцию и позиционирование бренда</a></li>
                                    <li><a href="#">Шаг 3. Создать косметический продукт</a></li>
                                    <li><a href="#">Шаг 4. Разработать упаковку и фирменный стиль</a></li>
                                    <li><a href="#">Шаг 5. Пройти процедуру сертификации</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="container">
                        <div className="inner-page-article-content-wrap">
                            <div className="inner-page-article-text-content">
                            ...
                            <div className="inner-page-article-img-content">
                                <img src={demoImg} alt="#" />
                            </div>
                        </div>
                        <div className="inner-page-article-content-wrap">
                        ...
                        <div className="inner-page-article-content-wrap left">
                            <div className="inner-page-article-text-content">
                        ...
                        <div className="inner-page-article-content-wrap">
                            <div className="inner-page-article-text-content full">
                                ...
                                <p>Прежде чем выйти на рынок, необходимо оформить все юридические документы и пройти сертификацию. Данный этап включает в себя регистрацию товарного знака, получение разрешение на продажу, сертификацию продукции по стандартам безопасности. Этим занимается юрист, которого можно найти самостоятельно или же воспользоваться услугами проверенных специалистов, рекомендованных компанией-производителем.</p>
                            </div>
                        </div>
                        <div className="inner-page-article-content-wrap">
                            <div className="inner-page-article-text-content full">
