...
const qizSlice = createSlice({
    ...
    reducers: {
        ...
        saveQuizOrderSize(state, action) {
            ...
            state.quizResult.calculateResult = {
                ...state.quizResult.calculateResult,
                totalWeight: `от ${minWeight} - до ${maxWeight} кг`,
            }
        },
        ...
        saveQuizUserdata(state) {
            ...
            const deliveryObj = state.qizSteps.find((stepItem) => stepItem.stepNum === 5);
            ...
            state.quizResult.resultOrderForm = {
                ...
                sendData: {
                    ...
                    productPrice: productPricePerItem,
                    productCategory: productCategory,
                    orderPackage: packageSize,
                    clientBudget: `${clientBudget}`,
                    orderDeadline: deadLineName,
                    orderService: additionalService,
                    servicePrice: additionalServicePrice,
                    productionDate: productionDate,
                    productQnt: totalQuantity,
                    deliveryWeight: totalProductWeight,
                    deliveryRange: totalDeliveryRange,
